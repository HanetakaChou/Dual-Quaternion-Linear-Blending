...
#ifndef NDEBUG
#include "../dxbc/Debug/CharacterAnimatedVS_bytecode.inl"
#include "../dxbc/Debug/CharacterAnimatedVS_fast_bytecode.inl"
#include "../dxbc/Debug/CharacterPS_bytecode.inl"
#else
#include "../dxbc/Release/CharacterAnimatedVS_bytecode.inl"
#include "../dxbc/Release/CharacterAnimatedVS_fast_bytecode.inl"
#include "../dxbc/Release/CharacterPS_bytecode.inl"
#endif
...
void AnimatedCharacter::load(ID3D11Device *d3d_device, ID3D11DeviceContext *d3d_device_context)
{
	...
	this->m_vertex_shader_linear = NULL;
	{
		...
		V(d3d_device->CreateVertexShader(CharacterAnimatedVS_bytecode, sizeof(CharacterAnimatedVS_bytecode), NULL, &m_vertex_shader_linear));
	}
	...
	this->m_vertex_shader_dual_quaternion_fast = NULL;
	{
		...
		V(d3d_device->CreateVertexShader(CharacterAnimatedVS_fast_bytecode, sizeof(CharacterAnimatedVS_fast_bytecode), NULL, &m_vertex_shader_dual_quaternion_fast));
	}
	...
	this->m_pixel_shader = NULL;
	{
		...
		V(d3d_device->CreatePixelShader(CharacterPS_bytecode, sizeof(CharacterPS_bytecode), NULL, &this->m_pixel_shader));
	}
	...
	this->m_input_layout = NULL;
	{
		...
		V(d3d_device->CreateInputLayout(input_element_descs, sizeof(input_element_descs) / sizeof(input_element_descs[0]), CharacterAnimatedVS_bytecode, sizeof(CharacterAnimatedVS_bytecode), &this->m_input_layout));
	}
